...
class Home extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <div class="col-md-8 col-xl-6 middle-wrapper profile" >
      <div class="row">
                  ...
                  <div class="card-header">
                      <div class="d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                              <img class="img-xs rounded-circle" src="https://scontent.fsgn2-6.fna.fbcdn.net/v/t39.30808-6/293034441_3278988778999228_6245077723265667568_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=fBaJXimB4gwAX-W2U__&_nc_ht=scontent.fsgn2-6.fna&oh=00_AfDEbgyaJfiTKU9UE5yrrk7ZaqFMC0D-aF_X3ZJbfZoq3w&oe=63611FC6" alt="" />
                              <div class="ml-2">
                                  <p class="tx-11 text-muted">Nguyễn Cao Thái</p>
                              </div>
                          </div>
                          <div class="dropdown">
